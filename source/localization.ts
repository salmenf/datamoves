...
export const LABELS = {
  "DE": {
    "heading": "Data Moves",
    "welcomeMessage1": "Willkommen! Diese Seite soll eine Übersicht und erste Einführung von Data Moves bieten. Data Moves sind im Bereich der Datenanalyse Aktionen, die die Werte, den Inhalt und/oder die Struktur eines Datensatzes ändern.",
    "welcomeMessage2": "Hier soll eine mögliche Auswahl von Data Moves interaktiv gezeigt werden, anhand der Programmiersprache Python und der zugehörigen Bibliothek Pandas. Grundkenntnisse in Python und Pandas werden vorausgesetzt.",
